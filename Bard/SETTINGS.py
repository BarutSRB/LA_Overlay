...
Sound_Shock         = Skill("Sound_Shock",         3,   4,    0,    2.55)
Prelude_of_Storm    = Skill("Prelude_of_Storm",    7,   None, 0,    5.95)
Wind_of_Music       = Skill("Wind_of_Music",       7,   4,    0,    5.95)
Sonic_Vibration     = Skill("Sonic_Vibration",    12,   6,    0.9,  10.2)
Rhapsody_of_Light   = Skill("Rhapsody_of_Light",  10,   None, 0,    8.5)
Soundholic          = Skill("Soundholic",         12,   None, 0,    10.2)
Heavenly_Tune       = Skill("Heavenly_Tune",      12,   8,    0.5,  10.2)
Guardian_Tune       = Skill("Guardian_Tune",       8,   8,    0,    6.8)
...
Symphonia           = Skill("Symphonia",         180,   6,    2,    120)
...
FLASH_COOLDOWN = [Sonic_Vibration, Heavenly_Tune, Symphonia]
